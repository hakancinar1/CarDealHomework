...
<div class="container mt-5">
    ...
    <div class="row mt-3">
        <div class="col-md-4 mb-4">
            <div class="card">
                <img src="public/photos/car1.png" class="card-img-top" style="object-fit: cover; height: 150px;">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                <img src="public/photos/car2.png" class="card-img-top" style="object-fit: cover; height: 150px;">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                <img src="public/photos/car3.png" class="card-img-top" style="object-fit: cover; height: 150px;">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                <img src="public/photos/car4.png" class="card-img-top" style="object-fit: cover; height: 150px;">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                <img src="public/photos/car5.png" class="card-img-top" style="object-fit: cover; height: 150px;">
                <div class="card-body">
